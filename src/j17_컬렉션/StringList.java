...
public class StringList {
	...
	public static void main(String[] args) {
		...
		System.out.println("0번의 인덱스의 값: " + subject);
		...
		System.out.println("contanins: " + contains);
		System.out.println("contaninsAll: " + containsAll);
		...
		System.out.println(list);
		list.retainAll(tempList);//해당컬렉션을 포함하는 것을 제외하고 다 지움
		System.out.println(list);
		...
		Arrays.asList(roleArray).forEach(arg -> {//->람다
