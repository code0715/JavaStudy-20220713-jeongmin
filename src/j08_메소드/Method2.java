...
public class Method2 {
	...
	public static void printData(String data) {
		while (true) {
			...
			String content = nextCommandIndex != -1 ? data.substring(contentIndex + 1)
	...
	public static void main(String[] args) {
		String data = "@Message:안녕하세요.@To:이정민@From:일정민@SendDate:2022/07/21";
		String data2 = "@Message:안녕하세요.@To:이정민@From:일정민@SendDate:2022/07/21";
		String data3 = "@Message:안녕하세요.@To:이정민@From:일정민@SendDate:2022/07/21";
