...
public class Computer {
	...
	public void powerOn() {
		...
		if(usb1 != null) usb1.coonnect();
		if(usb2 != null) usb2.coonnect();
		
		soundOn();
	}
	public void powerOff() {
		if(usb1 != null) usb1.discoonnect();
		if(usb2 != null) usb2.discoonnect();
		disConnectedDisplay();
	...
	private void showConnectionTerminalVersion() {
		if(connectionTerminal instanceof HDMI) {
			...
			System.out.println("Version Infomastion is missing");
		}
	}
}
