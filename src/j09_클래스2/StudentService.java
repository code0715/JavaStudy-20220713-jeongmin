...
public class StudentService {
	...
	private Student addStudent() {
		...
		System.out.println("더이상 학생을 등록 할 수 없습니다.");
		return null;
	}
	public Student inputStudent() {
		String studentName = null;
		int studentYear = 0;
		String studnetAddress = null;
		...
		System.out.print("주소 >>");
		studnetAddress = scanner.nextLine();
		
		System.out.print("연락처 >>");
		studentPhone = scanner.nextLine();
		
		Student s = new Student(studentName, studentYear, studnetAddress, studentPhone);
		return s;
	}
