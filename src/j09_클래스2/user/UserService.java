...
public class UserService {
	...
	private User addUser() {
		for(int i = 0; i < userArray.length; i++) {
			...
			System.out.println("[ " + userArray[i].getUserName() +  " ] 유저 등록 완료");
			return userArray[i];
		}
		System.out.println("더이상 유저를 등록 할 수 없습니다.");
		return null;
	}
	...
	public User inputUser() {
		...
		User s = new User(userName, password, name, email);
		return s;
	}
